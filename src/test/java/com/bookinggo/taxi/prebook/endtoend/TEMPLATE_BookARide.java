...
import static com.bookinggo.taxi.prebook.endtoend.TEMPLATE_SearchAndBookingHelpers.*;
...
public class TEMPLATE_BookARide extends TestConfig {
    ...
    public void unsuccessfulBookingRequest() throws IOException, SQLException {
        ...
        String postBodyJson = TEMPLATE_BookingRequestBuilder.bookingRequestPayload(invalidSearchResultId, testAccountId);
